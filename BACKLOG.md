...
| C26-07 (bloc) | **Question de réconciliation ouverte** (nouveau protocole Marc ↔ §2.1 « plus de revue ») : le dry-run + le fail-safe dépendent de la décision « `00 · À vérifier` réintroduit ou app comme file de revue ? » — à trancher avant de coder le routage de revue | ⛔ bloqué (décision Marc) |
