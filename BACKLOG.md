...
| C26-08 | **Campagne de re-analyse** (budget/jour, reprenable) — SEULEMENT après feu vert. ⚠ Coût mesuré C26-07 : **0,026 $/doc × 3 733 docs ≈ 97 $** vs frein campagnes 30 $ (27,25 $ déjà consommés au 09-07). 3 options chiffrées présentées à Marc (flux vivant seul / ciblée ~700 docs ≈ 18 $ / complète ≈ 97 $ + plafond à relever) | ⬜ **décision Marc attendue** |
