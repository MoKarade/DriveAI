...
const TEXTES = {
  fr: {
    ...
    explorateurNote: 'Un fichier s’ouvre dans Google Drive. Création de dossiers et rangement par glisser-déposer : bientôt.',
  ...
  en: {
    ...
    explorateurNote: 'Files open in Google Drive. Folder creation and drag-and-drop filing: coming soon.',
