...
//
// Mesuré avant de coder : cette app était déjà installable, et son jeu d'icônes était le plus
// complet du parc — SVG, PNG 192, PNG 512 et une maskable 512 DISTINCTE. Il n'y manquait que
// l'identité de l'installation et le mode de lancement, plus un `scope` qui était implicite.
//
...
// (13 octets après la signature, aucun outil requis). C'est ce qui rendait FinanceAI non
// installable — une seule icône, en SVG, que Chrome refuse pour fabriquer le WebAPK.
//
