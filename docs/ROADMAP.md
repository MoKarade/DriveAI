...
| 6 | **Correction via mail → mini-formulaire** (cas « Inconnu » + entités à valider) | Contrôle | M-L | [0003](adr/0003-controle-correction.md) | 🟦 formulaire Google → corrections (few-shot) + **entité corrigée promue « validée »** (C6-04) ✅ · lien au résumé hebdo · **⚠️ nouveau scope `forms` = ré-autorisation de Marc** · déplacement du fichier corrigé = à suivre |
