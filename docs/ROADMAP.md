...
|---|----------|-----|--------|-----|--------|
| 1 | **Fondation testable** — refactor logique pure ↔ effets de bord, filet de tests en CI (Node), **Journal borné + onglet `Santé`**, + test d'invariant vie privée « aucun corps de document dans l'état/les logs » ([0007](adr/0007-securite-vie-privee.md)) | Qualité (socle) | M | [0006](adr/0006-architecture-qualite.md) | ✅ socle posé (harness + 46 tests + job CI · Journal borné · onglet `Santé`) — couverture à étendre au fil des chantiers |
