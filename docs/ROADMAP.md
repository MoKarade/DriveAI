...
| 16 | **Tri Gmail natif** — libellés (sous-libellés existants) + archivage prudent + ⚠️ phishing + newsletters jamais lues, au fil de l'eau (remplace la tâche Cowork de Marc) | Mails | M-L | [0012](adr/0012-tri-gmail-natif.md) | 🟦 CODÉ (décision Marc 2026-07-06, ADR-0012) : PR `do-not-merge` en attente du GO temps-réel de Marc (merge ⇒ gel jusqu'à ré-autorisation) |
