...
| 3 | **Nommage par type de doc** + « deviner depuis le nom d'origine » + nouveaux dossiers `07 · Santé` et `_Technique` | Précision | M | [0002](adr/0002-refonte-taxonomie-entites-nommage.md) | 🟦 nommage par type ✅ (`nomParType_`, granularité/libellé par type) · deviner-du-nom + `07·Santé`/`_Technique` à suivre |
