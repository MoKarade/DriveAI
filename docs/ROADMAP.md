...
| 12 | **Historique Gmail complet** — scan ancré rétrograde (`before:` persisté), toutes les vieilles PJ classées | Mails | M | [0010](adr/0010-mails-historique-visibilite.md) | 🟦 codé : curseur ABSOLU vers le passé (jour le plus ancien traité + 1, re-couverture idempotente — jamais de trou ni plateau), terminaison figée (coût nul ensuite), fil-poison sauté avec journal (convergence) ✅ |
