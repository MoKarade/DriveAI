...
| 9 | **App web (Phase 4)** — recherche structurée (Index + plein texte natif Drive), tableau de bord santé, corrections (login Google) | Contrôle/Accès | L | [0008](adr/0008-app-web-recherche-controle.md) | 🟦 v1 livrée (`app/`, SPA React/Vite/TS sans backend) : **dashboard santé** + **corrections** (validation 1-clic des entités = reste du #4 ✅ ; reclassement immédiat sous garde-fous TS miroir testés — jamais de suppression par construction) · CI dédiée · **⚙️ côté Marc : client OAuth + projet Vercel (10 min, DEPLOIEMENT §Phase 4)** · recherche structurée = à suivre |
