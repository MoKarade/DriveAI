<!-- Extrait de l'ancien CLAUDE.md (§ 9. Leçons apprises (règles durables)), texte inchangé. Le CLAUDE.md court renvoie ici. -->

# Leçons apprises (règles durables)
...
*(passage retiré : donnée personnelle, voir la liste privée)*
