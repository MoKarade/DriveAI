...
function ctxLigne() {
  return load(['Config.gs', 'Entites.gs', 'Consolidation.gs', 'Reset.gs', 'Missions.gs', 'Router.gs', 'DryRunV2.gs']);
}
...
function ctxTraiter(opts) {
  ...
  const ctx = load(['Config.gs', 'Entites.gs', 'Consolidation.gs', 'Reset.gs', 'Missions.gs', 'Router.gs', 'DryRunV2.gs']);
